...
using CeciRMQ.Test.Fakers.Address;
using CeciRMQ.Test.Fakers.Commons;
using CeciRMQ.Test.Fakers.Email;
using CeciRMQ.Test.Fakers.Register;
...
namespace CeciRMQ.Test.Services
{
    public class RegisterServiceTest
    {
        ...
        private readonly Mock<IMessageService<EmailRequestDTO>> _mockIMessageService;
        ...
        public RegisterServiceTest()
        {
            ...
            _mockIMessageService = new Mock<IMessageService<EmailRequestDTO>>();
