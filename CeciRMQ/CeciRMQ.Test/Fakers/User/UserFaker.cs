...
namespace CeciRMQ.Test.Fakers.User
{
    public static class UserFaker
    {
        public static Faker<CeciRMQ.Domain.Entities.User> UserEntity()
        {
            return new Faker<CeciRMQ.Domain.Entities.User>()
                .CustomInstantiator(p => new CeciRMQ.Domain.Entities.User
                {
                    ...
                    RefreshToken = new List<CeciRMQ.Domain.Entities.RefreshToken>(),
                    RegistrationDate = p.Date.Recent(),
                    RegistrationToken = new List<CeciRMQ.Domain.Entities.RegistrationToken>(),
                    Validated = p.Random.Bool(),
                    ValidationCode = new List<CeciRMQ.Domain.Entities.ValidationCode>(),
